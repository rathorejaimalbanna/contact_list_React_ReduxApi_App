...
import { updateContactAsync } from '../Redux/contactReducer';
...
function UpdateModal(props) {
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(updateContactAsync(data)); // Dispatch action to update contact
          ...
          <Row className="mb-3">
            ...
            <Form.Group as={Col} md="6" controlId="validationCustom03">
              ...
              <Form.Control
                ...
                placeholder="City"
                ref={city}
                defaultValue={props.modalData.city}
                required
              />
            ...
            <Form.Group as={Col} md="6" controlId="validationCustom05">
              ...
              <Form.Control
                ...
                placeholder="Phone"
                ref={phone}
                defaultValue={props.modalData.phone}
                required
              />
